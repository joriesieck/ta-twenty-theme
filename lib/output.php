 ...
 * TA Twenty.
 *
 * This file adds the required CSS to the front end to the TA Twenty Theme.
 *
 * @package TA Twenty
 * @author  StudioPress
...
add_action( 'wp_enqueue_scripts', 'ta_twenty_css' );
/**
...
function ta_twenty_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'ta_twenty_logo_width', 350 );
