 ...
 * TA Twenty.
 *
 * This file adds the required helper functions used in the TA Twenty Theme.
 *
 * @package TA Twenty
 * @author  StudioPress
 ...
 */
function ta_twenty_color_contrast( $color ) {
 ...
 */
function ta_twenty_color_brightness( $color, $change ) {
