...
add_action( 'wp_enqueue_scripts', 'ta_twenty_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function ta_twenty_custom_gutenberg_css() {
...
CSS;
	...
	$css .= ta_twenty_inline_font_sizes();
	$css .= ta_twenty_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'ta_twenty_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function ta_twenty_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= ta_twenty_editor_inline_color_palette();
 ...
 */
function ta_twenty_inline_font_sizes() {
 ...
 */
function ta_twenty_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function ta_twenty_editor_inline_color_palette() {
