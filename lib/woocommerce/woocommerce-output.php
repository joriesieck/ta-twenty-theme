 ...
 * TA Twenty.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the TA Twenty Theme.
 *
 * @package TA Twenty
 * @author  StudioPress
...
add_filter( 'woocommerce_enqueue_styles', 'ta_twenty_woocommerce_styles' );
/**
 ...
 */
function ta_twenty_woocommerce_styles( $enqueue_styles ) {

	$enqueue_styles[ genesis_get_theme_handle() . '-woocommerce-styles' ] = [
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/ta-twenty-woocommerce.css',
		'deps'    => '',
...
add_action( 'wp_enqueue_scripts', 'ta_twenty_woocommerce_css' );
/**
 ...
 */
function ta_twenty_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'ta_twenty_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'ta_twenty_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		ta_twenty_color_contrast( $color_accent )
	) : '';
