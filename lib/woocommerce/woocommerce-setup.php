 ...
 * TA Twenty.
 *
 * This file adds the required WooCommerce setup functions to the TA Twenty Theme.
 *
 * @package TA Twenty
 * @author  StudioPress
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'ta_twenty_woocommerce_breakpoint' );
/**
 ...
 */
function ta_twenty_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'ta_twenty_default_products_per_page' );
/**
 ...
 */
function ta_twenty_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'ta_twenty_woocommerce_pagination' );
/**
 ...
 */
function ta_twenty_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'ta-twenty' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'ta-twenty' ) );

	return $args;

}

add_action( 'after_switch_theme', 'ta_twenty_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function ta_twenty_woocommerce_image_dimensions_after_theme_setup() {
	...
	ta_twenty_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'ta_twenty_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function ta_twenty_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function ta_twenty_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'ta_twenty_gallery_image_thumbnail' );
/**
 ...
 */
function ta_twenty_gallery_image_thumbnail( $size ) {
